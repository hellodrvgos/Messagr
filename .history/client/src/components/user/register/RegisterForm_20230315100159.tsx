...
import TextInput from "../../AuthPage/Extras/TextInput";
import PhotoInput from "../../AuthPage/Extras/PhotoInput";
import Button from "../../AuthPage/Extras/Button";
import Link from "../../AuthPage/Extras/Link";
