...
export interface SnackbarUnstyledOwnProps extends Omit<UseSnackbarParameters, 'ref'> {
     ...
     */
    slotProps?: {
        clickAwayListener?: SlotComponentProps<typeof ClickAwayListener, SnackbarUnstyledClickAwayListenerSlotPropsOverrides, SnackbarUnstyledOwnerState>;
        root?: SlotComponentProps<'div', SnackbarUnstyledRootSlotPropsOverrides, SnackbarUnstyledOwnerState>;
    };
    /**
