...
import { SelectOption, UseSelectButtonSlotProps, UseSelectListboxSlotProps } from '@mui/base/useSelect';
...
export interface SelectUnstyledOwnProps<TValue extends {}> extends SelectUnstyledCommonProps {
     ...
     */
    slotProps?: {
        root?: SlotComponentProps<'button', SelectUnstyledRootSlotPropsOverrides, SelectUnstyledOwnerState<TValue>>;
        listbox?: SlotComponentProps<'button', SelectUnstyledListboxSlotPropsOverrides, SelectUnstyledOwnerState<TValue>>;
        popper?: SlotComponentProps<typeof PopperUnstyled, SelectUnstyledPopperSlotPropsOverrides, SelectUnstyledOwnerState<TValue>>;
    };
    /**
