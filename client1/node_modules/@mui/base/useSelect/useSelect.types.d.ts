...
import { OptionState, UseListboxOptionSlotProps, UseListboxRootSlotProps } from '@mui/base/useListbox';
import { EventHandlers } from '@mui/base/utils/types';
import { SelectChangeNotifiers } from '@mui/base/useSelect/useSelectChangeNotifiers';
...
interface UseSelectCommonProps<TValue> {
    ...
    onHighlightChange?: (e: React.MouseEvent<Element, MouseEvent> | React.KeyboardEvent<Element> | React.FocusEvent<Element, Element> | null, highlighted: TValue | null) => void;
    open?: boolean;
